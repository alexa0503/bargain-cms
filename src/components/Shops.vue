      ...
      <v-card>
        <v-card-title>
          ...
          <div class="flex xs4">
            <v-form ref="form" @submit.prevent="submit">
              <v-text-field v-model="search" :append-icon-cb="iconClick" :append-icon="searchIcon" label="搜索" single-line hide-details></v-text-field>
            </v-form>
          </div>
        </v-card-title>
        <v-data-table :loading="loading" :headers="headers" :items="items" hide-actions class="elevation-1">
          ...
          <template slot="items" slot-scope="props">
            ...
            <td>
              <div>
                <v-btn dark fab small color="primary">
